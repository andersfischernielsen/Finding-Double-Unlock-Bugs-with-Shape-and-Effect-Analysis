...
\newpar Implementing the shortcomings of the prototype of this project explained in the previous section to detect a larger number of true positives should be done by \todo{Explain how to improve accuracy} [...]. This would improve the accuracy and therefore the usefulness of the prototype.
